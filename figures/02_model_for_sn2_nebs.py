...
true_ts_0 = read('./ts-test-mp2.xyz', ':')
guess_ts_0 = read('./no-rattle/ts-guesses/no-climb/ts-guesses-mp2.xyz', ':')
...
true_ts_1 = read('./ts-test-mp2.xyz', ':')
guess_ts_1 = read('./rattled-stdev-0.02/ts-guesses/no-climb/ts-guesses-mp2.xyz', ':')
...
true_ts_2 = read('./ts-test-mp2.xyz', ':')
guess_ts_2 = read('./rattled-stdev-0.05/ts-guesses/no-climb/ts-guesses-mp2.xyz', ':')
...
ax1.hist(true_ts_mp2_guess_ts_mp2_err_1, bins+bin_width/3, width=bin_width/3, color='red', zorder=2, edgecolor='#666666', label='MACE-sn2-rattled')

ax2.hist(true_ts_mp2_guess_ts_mp2_err_0, bins, width=bin_width/3, color='blue', zorder=2, edgecolor='#666666', label='MACE-sn2')
ax2.hist(true_ts_mp2_guess_ts_mp2_err_1, bins+bin_width/3, width=bin_width/3, color='red', zorder=2, edgecolor='#666666', label='MACE-sn2-rattled')
